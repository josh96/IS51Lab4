...
question = "What is the capital of Californi". The answer is "Sacramento".
...
main
  question = "What is th ecapital of California"
  answer = "California"
...
def main():
    question = "what is capital of California? "
    answer = "Sacramento"
    ask(question, answer)
...
def ask(question, answer, max_tries=3):
    ...
    while tries < max_tries:
        ...
        if ans == answer:
            ...
            break
    if ans != answer:
        print("You have used up your alloment of guesses.")
